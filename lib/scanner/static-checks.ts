...
const TRACKER_SIGNATURES: Array<{ name: string; needle: RegExp }> = [
  ...
  { name: "Google Ads / DoubleClick", needle: /googleadservices\.com|doubleclick\.net|googlesyndication/i },
  ...
  { name: "Amplitude", needle: /cdn\.amplitude\.com|amplitude\.init/i },
  { name: "Heap", needle: /cdn\.heap\.io|heap\.load/i },
  { name: "PostHog", needle: /app\.posthog\.com|posthog\.init/i },
  { name: "Plausible", needle: /plausible\.io\/js/i },
  { name: "Fathom Analytics", needle: /cdn\.usefathom\.com/i },
  { name: "Matomo / Piwik", needle: /matomo\.js|_paq\.push|piwik\.js/i },
  { name: "Cloudflare Web Analytics", needle: /static\.cloudflareinsights\.com/i },
  { name: "Vercel Analytics", needle: /_vercel\/insights|va\.vercel-scripts/i },
  { name: "LinkedIn Insight", needle: /snap\.licdn\.com\/li\.lms-analytics/i },
  { name: "TikTok Pixel", needle: /analytics\.tiktok\.com\/i18n\/pixel/i },
  { name: "Pinterest Tag", needle: /s\.pinimg\.com\/ct\/core/i },
  { name: "Twitter / X Pixel", needle: /static\.ads-twitter\.com\/uwt/i },
  { name: "Snap Pixel", needle: /sc-static\.net\/scevent/i },
  { name: "Reddit Pixel", needle: /www\.redditstatic\.com\/ads\/pixel/i },
  { name: "HubSpot", needle: /js\.hs-scripts\.com|js\.hsforms\.net|js\.hubspot\.com/i },
  { name: "Intercom", needle: /widget\.intercom\.io/i },
  { name: "Drift", needle: /js\.driftt\.com|driftt\.com\/iframe/i },
  { name: "Crisp Chat", needle: /client\.crisp\.chat/i },
  { name: "Zendesk Chat", needle: /static\.zdassets\.com\/ekr/i },
  { name: "FullStory", needle: /fullstory\.com\/s\/fs\.js/i },
  { name: "LogRocket", needle: /cdn\.logrocket\.io/i },
  { name: "Microsoft Clarity", needle: /www\.clarity\.ms\/tag/i },
  { name: "Yandex Metrica", needle: /mc\.yandex\.ru\/metrika/i },
  { name: "Sentry", needle: /browser\.sentry-cdn\.com|@sentry\/browser/i },
];
